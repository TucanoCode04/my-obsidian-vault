...
where $E=\frac{1}{2}mv^2$ is the kinetic energy of the charge, and we have that $E \propto r_C^2$. This radius is also known as the cyclotron radius. We see that the radius is dependent on the square root of the energy, similar to the case of a classical harmonic oscillator.
