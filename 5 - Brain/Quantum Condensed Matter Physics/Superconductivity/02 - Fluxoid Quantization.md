...
The equation holds for any shape of the closed contour $C$. If $C$ is simply-connected(like a circle), the contour can be continuously shrunk to a point without leaving the superconductor, and 
