...
- along the y direction, the field is perpendicular to the current flow, so the phase changes linearly with z, with the formula: $\frac{\partial \psi}{\partial z} =  \frac{2\pi}{\Phi_0} B_y h_{eff}$ 
## References
