...
$\Phi$ is in tur the sum of the external flux $\Phi_{ext}$ and the flux generated by the current flowing in the loop $\Phi_{int}$. We can divide the total flux as: 
